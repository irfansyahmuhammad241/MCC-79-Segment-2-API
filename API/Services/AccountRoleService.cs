...
namespace API.Services
{
    public class AccountRoleService
    {
        ...
        public GetAccountRolesDto? GetAccountRole(Guid guid)
        {
            ...
            var toDto = new GetAccountRolesDto
            {
                Guid = accountRole.Guid,
                AccountGuid = accountRole.AccountGuid,
                RoleGuid = accountRole.RoleGuid,
        ...
        public GetAccountRolesDto? CreateAccountRole(NewAccountRolesDto newAccountRoleDto)
        {
        ...
        public int UpdateAccountRole(UpdateAccountRolesDto updateAccountRole)
        {
