...
namespace API.Services
{
    public class RoleController
    {
        public class RoleService
        {
            ...
            public IEnumerable<GetRolesDto>? GetRole()
            {
            ...
            public GetRolesDto? GetRole(Guid guid)
            {
            ...
            public GetRolesDto? CreateRole(NewRolesDto newRoleDto)
            {
                var role = new Role
                {
                    Guid = new Guid(),
