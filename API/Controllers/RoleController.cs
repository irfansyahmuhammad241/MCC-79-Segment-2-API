...
namespace API.Controllers
{
    ...
    public class RoleController : ControllerBase
    {
        ...
        public IActionResult GetAll()
        {
            ...
            if (entities == null)
            {
                return NotFound(new ResponseHandler<GetRolesDto>
                {
            ...
            return Ok(new ResponseHandler<IEnumerable<GetRolesDto>>
            {
        ...
        public IActionResult GetByGuid(Guid guid)
        {
            ...
            return Ok(new ResponseHandler<GetRolesDto>
            {
                Code = StatusCodes.Status200OK,
                Status = HttpStatusCode.OK.ToString(),
                Message = "Data found",
        ...
        [HttpPost]
        public IActionResult Create(NewRolesDto newRoleDto)
        {
            var createRole = _service.CreateRole(newRoleDto);
            if (createRole is null)
            {
                return BadRequest(new ResponseHandler<GetRolesDto>
                {
